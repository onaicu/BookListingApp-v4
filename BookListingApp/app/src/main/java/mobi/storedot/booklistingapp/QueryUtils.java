...
public final class QueryUtils {
     ...
     * earthquake data from GG(Google Book API).
     */
    ...
    /**
     * Query the GG dataset and return a list of {@link Book} objects.
     */
    ...
    */
    ...
    private static List<Book> extractItemsFromJson(String bookJSON) {
        ...
        try {
            ...
            /*Extract the JSONArray associated with the key called "items", which represents a list of items (or books).
              The optJSONArray is used to return a JSONArray if it exist for a given key name and if array doesn't exist then
              it will return null
              */
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // key called "volumeInfo", which represents a list of all info for that book.

                JSONObject volumeinfo = currentBook.getJSONObject("volumeInfo");

                if(volumeinfo.has("authors")){
                    // Extract the value for the key called "categories"
                String categories = volumeinfo.optString("categories");
                ...
                // Create a new {@link Book} object with the title, authors, categories/topics,
                // and url from the JSON response.
                Book book = new Book(categories, author, title, url);
